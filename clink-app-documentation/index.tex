...
\addcontentsline{toc}{chapter}{III. Sound classification predictive models}
\chapter*{III. Sound classification predictive models}
\

%----------------------------------------------------------------------------------------
%	Models brief description
%----------------------------------------------------------------------------------------
\addcontentsline{toc}{section}{III.1. Models brief description}
...
%----------------------------------------------------------------------------------------
\addcontentsline{toc}{subsection}{III.1.1. Bidirectional LSTM for audio labeling with Keras}
...
%	Evaluation metric
%----------------------------------------------------------------------------------------
\addcontentsline{toc}{section}{III.2. Evaluation metric}
...
\addcontentsline{toc}{chapter}{IV. State of the art}
\chapter*{IV. State of the art}

\addcontentsline{toc}{section}{IV.1. Problem description}
...
\addcontentsline{toc}{section}{IV.2. Short audio files classification}
\section*{IV.2. Short audio files classification}

\addcontentsline{toc}{subsection}{IV.2.1. Problem statement}
...
\addcontentsline{toc}{subsection}{IV.2.2. Dataset description}
...
\addcontentsline{toc}{subsection}{IV.2.3. Proposed solution}
...
\addcontentsline{toc}{section}{IV.4. State of the art}
...
\addcontentsline{toc}{section}{IV.5. Relevant articles}
...
\addcontentsline{toc}{section}{IV.6. Relevant articles}
...
\addcontentsline{toc}{chapter}{VI. Risk assessment}
...
%----------------------------------------------------------------------------------------
%	Technical report of Clink application
%----------------------------------------------------------------------------------------


\addcontentsline{toc}{chapter}{VII. Technical report of Clink application}
\chapter*{VII. Technical report of Clink application}

%----------------------------------------------------------------------------------------
%	Problem presentation
%----------------------------------------------------------------------------------------
\addcontentsline{toc}{section}{VII.1. Problem presentation}
...
%	Motivation
%----------------------------------------------------------------------------------------
\addcontentsline{toc}{subsection}{VII.1.1. Our motivation}
...
%----------------------------------------------------------------------------------------
%	The summary of the state-of-the-art
%----------------------------------------------------------------------------------------
\addcontentsline{toc}{section}{VII.2. The summary of the state-of-the-art}
...
%----------------------------------------------------------------------------------------
%	Proposed solution - CLINK application
%----------------------------------------------------------------------------------------
\addcontentsline{toc}{section}{VII.3. Proposed solution - CLINK application}
...
%	Results /  Evaluation
%----------------------------------------------------------------------------------------
\addcontentsline{toc}{section}{VII.4. Results /  Evaluation}
...
%----------------------------------------------------------------------------------------
\addcontentsline{toc}{section}{VII.5. Comparison with other solutions}
...
\hline
\rowcolor[rgb]{0.8588, 0.2823, 0.1725}\multicolumn{5}{|c|}{\textcolor{white}{Results obtained using pre-trained models}} \\
\hline
\cellcolor[rgb]{0.6745, 0.686, 0.709}
\textit{\textbf{\textcolor{white} {\textbf{Model Name}}}} & \cellcolor[rgb]{0.965, 0.969, 0.967}  \textbf{Train loss} & \cellcolor[rgb]{0.965, 0.969, 0.967}  \textbf{Train acc.} 
& \cellcolor[rgb]{0.965, 0.969, 0.967}  \textbf{Test loss} 
& \cellcolor[rgb]{0.965, 0.969, 0.967}  \textbf{Test acc.}  \\
\hline
\cellcolor[rgb]{0.6745, 0.686, 0.709}
\textit{\textbf{\textcolor{white}{VGG16}}}& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0.0034} & \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,8140} 
& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,0083} 
& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,5731}  \\
\hline
\cellcolor[rgb]{0.6745, 0.686, 0.709}
\textit{\textbf{\textcolor{white}{VGG19}}}& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0.0032} & \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,8222} 
& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,0096} 
& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,5287}  \\
\hline
\cellcolor[rgb]{0.6745, 0.686, 0.709}
\textit{\textbf{\textcolor{white}{ResNet50}}}& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0.0017} & \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,9181} 
& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,0090} 
& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,5545}  \\
\hline
\cellcolor[rgb]{0.6745, 0.686, 0.709}
\textit{\textbf{\textcolor{white}{ResNet50V2}}}& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0.0028} & \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,8578} 
& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,0101} 
& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,4770}  \\
\hline
\cellcolor[rgb]{0.6745, 0.686, 0.709}
\textit{\textbf{\textcolor{white}{InceptionV3}}}& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0.0050} & \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,7188} 
& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,0114} 
& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,4230}  \\
\hline
\cellcolor[rgb]{0.6745, 0.686, 0.709}
\textit{\textbf{\textcolor{white}{InceptionResNetV2}}}& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0.0034} & \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,8159} 
& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,0106} 
& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,4833}  \\
\hline
\cellcolor[rgb]{0.6745, 0.686, 0.709}
\textit{\textbf{\textcolor{white}{MobileNet}}}& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0.0032} & \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,8341} 
& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,0087} 
& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,5396}  \\
\hline
\cellcolor[rgb]{0.6745, 0.686, 0.709}
\textit{\textbf{\textcolor{white}{MobileNetV2}}}& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,0035} & \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,8068} 
& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,0106} 
& \cellcolor[rgb]{0.965, 0.969, 0.967}  {0,4677}  \\
\hline
\end{tabular}
\end{footnotesize}
\end{center}
...
%  Future work
%----------------------------------------------------------------------------------------
\addcontentsline{toc}{section}{VII.6. Future work}
...
%  Conclusions
%----------------------------------------------------------------------------------------
\addcontentsline{toc}{section}{VII.7. Conclusions}
...
%  Links
%----------------------------------------------------------------------------------------
\addcontentsline{toc}{section}{VII.8. Links}
\section*{VII.8. Links}
\

\textbf{\footnotemark The Github repository can be accessed at:}

\footnotetext{Permission required}
...
\bibitem[12]{12} \textbf{"Classifying Urban sounds using Deep Learning"}, Mike Smales: \textit{https://github.com/mikesmales/Udacity-ML-Capstone/blob/master/Report/Report.pdf}

\bibitem[13]{13} \textbf{"Data Science for Good: Stopping Illegal Deforestat"}, Sara Hooker, Sean McPherson: \textit{https://mlconf.com/sessions/data-science-for-good-stopping-illegal-deforestat-2/}

\bibitem[14]{14} Eduardo Fonseca, Manoj Plakal, Frederic Font, Daniel P. W. Ellis, Xavier Serra.\\ \textbf{"AUDIO TAGGING WITH NOISY LABELS AND MINIMAL SUPERVISION"} in Detection and Classification of Acoustic Scenes and Events 2019 [PDF]
\end{thebibliography}
