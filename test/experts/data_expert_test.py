...
class TestStringMethods(unittest.TestCase):
    ...
    def test_get_all_labels(self):
        ...
        submission_df = pd.read_csv(
            "../../../data/freesound-audio-tagging-2019/sample_submission.csv"
        )
    ...
    def test_get_train_curated_wav_names(self):
        data_expert = DataExpert()
        self.assertEqual(
            data_expert.get_train_curated_wav_names(),
            list(
                os.listdir("../../../data/freesound-audio-tagging-2019/train_curated")
            ),
        )
    ...
    def test_train_noisy_wav_names(self):
        data_expert = DataExpert()
        self.assertEqual(
            data_expert.get_train_noisy_wav_names(),
            list(os.listdir("../../../data/freesound-audio-tagging-2019/train_noisy")),
        )
